...
class SelectionHelper {
	 ...
	 */
	constructor( renderer, cssClassName, bounds ) {
	...
	_onSelectStart( event ) {
		...
		this._startPoint.x = event.clientX - this.bounds.left;
		this._startPoint.y = event.clientY - this.bounds.top;
	...
	_onSelectMove( event ) {
		...
		this._pointBottomRight.x = Math.max( this._startPoint.x, event.clientX - this.bounds.left );
		this._pointBottomRight.y = Math.max( this._startPoint.y, event.clientY - this.bounds.top);
		this._pointTopLeft.x = Math.min( this._startPoint.x, event.clientX - this.bounds.left);
		this._pointTopLeft.y = Math.min( this._startPoint.y, event.clientY - this.bounds.top);
