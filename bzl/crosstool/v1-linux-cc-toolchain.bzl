"""module
Toolchain configuration file for v1-linux
Info at https://<REMOVED_BEFORE_OPEN_SOURCING>.atlassian.net/l/cp/X9twrGak
"""
...
def _impl(ctx):
    ...
    target = "x86_64-niantic_v1.0-linux-gnu"
    ...
    cxx_builtin_include_directories = [
        "/{{deceive_bazel_header_deps}}/external/v1-linux/x86_64-niantic_v1.0-linux-gnu/x86_64-niantic_v1.0-linux-gnu/sysroot/usr/include/",
        "/{{deceive_bazel_header_deps}}/external/v1-linux/x86_64-niantic_v1.0-linux-gnu/x86_64-niantic_v1.0-linux-gnu/include/c++/11.2.0",
        "/{{deceive_bazel_header_deps}}/external/v1-linux/x86_64-niantic_v1.0-linux-gnu/include",
        "/{{deceive_bazel_header_deps}}/external/v1-linux/x86_64-niantic_v1.0-linux-gnu/lib/gcc/x86_64-niantic_v1.0-linux-gnu/11.2.0/include",
        "/{{deceive_bazel_header_deps}}/external/v1-linux/x86_64-niantic_v1.0-linux-gnu/lib/gcc/x86_64-niantic_v1.0-linux-gnu/11.2.0/include-fixed",
        "/{{deceive_bazel_header_deps}}/external/v1-linux/x86_64-niantic_v1.0-linux-gnu/lib/gcc/x86_64-niantic_v1.0-linux-gnu/11.2.0/install-tools/include",
    ...
    tool_paths = [
        tool_path(name = "gcc", path = "clang-v1-linux-wrapper.sh"),
                ...
                flag_groups = [
                    flag_group(
                        flags = [
                            ...
                            "-L%s/lib64" % sysroot,
                            "-L%s/lib" % sysroot,
                            "-L%s/../lib/gcc/x86_64-niantic_v1.0-linux-gnu/11.2.0" % sysroot,
                            "-stdlib=libstdc++",
                            "-lstdc++",
                            "-lm",
                            "-Wl,--whole-archive",
    ...
    return cc_common.create_cc_toolchain_config_info(
        ...
        host_system_name = "x86_64-niantic_v1.0-linux-gnu",
...
_v1_linux_cc_toolchain_config = rule(
    implementation = _impl,
    attrs = {
        "workspace_env": attr.label(default = "@workspace-env//:workspace-env", allow_single_file = True),
        "linux": attr.label(mandatory = True),
        "strip_tool": attr.label(default = "//bzl/crosstool:strip-v1-linux-wrapper", executable = True, cfg = "exec"),
...
def v1_linux_cc_toolchain(name, linux, cpu_microarch, tools, **kwargs):
    """Macro to create a bazel cc_toolchain that targets V1 Linux machines."""
    config_name = "{}-config".format(name)
    _v1_linux_cc_toolchain_config(
        name = config_name,
        linux = linux,
