...
#define LWS_LIBRARY_VERSION_PATCH_ELABORATED 99 - v4 .3.0 - 277 - gf9d1f25a
...
#define LWS_BUILD_HASH "v4.3.0-277-gf9d1f25a"
...
// #define LWS_HAVE_OPENSSL_ECDH_H // <<<<<<<<< OpenSSL
...
#define LWS_LIBRARY_VERSION "4.3.99-v4.3.0-277-gf9d1f25a"
