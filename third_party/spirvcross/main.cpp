...
struct CLIArguments
{
	...
	bool unmap_locations = false;
	bool unmap_bindings = false;
};
...
static void print_help_glsl()
{
	...
	fprintf(stderr, "\nGLSL options:\n"
	                ...
	                "\t[--unmap-locations]:\n\t\tRemove layout(location) decorations.\n"
	                "\t[--unmap-bindings]:\n\t\tRemove layout(binding) decorations.\n"
	);
	// clang-format on
}
...
static int main_inner(int argc, char *argv[])
{
	...
	cbs.add("--unmap-locations", [&args](CLIParser &) { args.unmap_locations = true; });
	cbs.add("--unmap-bindings", [&args](CLIParser &) { args.unmap_bindings = true; });
